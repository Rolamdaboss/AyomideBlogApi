...
namespace Blog.Controllers
{
    ...
    public class PostController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public IActionResult GetById(int id, [FromQuery] bool withLikes = false, [FromQuery] bool withComments = false, [FromQuery] bool withcategories = false)
        {
            Post? post =  _ipostService.GetPost(id, withLikes, withComments, withcategories);
        ...
        public IActionResult CreatePost([FromBody] CreatePostDto postdto)
        {
            ...
            Post? craetePost = _ipostService.CreatePost(newPost, postdto.categoryIds, out string message);
